...
> The room the examination takes place in is not the Hall chamber. It is a record room — three walls of archived material and one window with ice on the outside of the glass — and it has the quality of a room designed to prevent the disappearance of things. Warden Asha Merel has assembled the relevant precis: the arc state records, the account the party gave in the Hall session, and the contradiction map that Iriane Quell prepared at the Chronoplast. She is not using them as evidence. She is using them as the architecture around which to ask questions that documents cannot answer. Black Marshal Sevran is in the corner and he is not speaking unless addressed, and his expression is the expression of a man who has sat through this kind of conversation before and is waiting to see which version this is. If Kain is present, he is seated at the table. He has already read everything. He is waiting for the party to say it aloud, in sequence, to someone who will not permit abbreviation.
