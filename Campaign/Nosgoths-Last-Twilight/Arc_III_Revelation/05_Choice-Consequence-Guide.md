# Arc III: Revelation Choice Consequence Guide
...
- Rejection supports escape, defiance, and scenes where Wheel agents turn grief, funerary authority, or prophecy against the party openly.
- Acceptance or bargaining supports ritual audiences, negotiated passage, or soft-captivity encounters where compliance is tested rather than immediately enforced.

### Immediate Narrative Changes

- Rejecting the Wheel hardens the party's moral frame around burdened choice, even if they have no clean answer yet.
- Accepting or bargaining grants short-term coherence and relief, but it immediately changes how allies read the party's will.

### Faction Pressure

- Wheel loyalists press harder after acceptance or compromise because they smell fatigue and usable doctrine.
- Kain-aligned and Balance-minded observers become more active after outright rejection because the party have now declared themselves against managed inevitability.

### Later Payoffs

- A bargain with surrender logic returns later as an excuse for delay, concealment, or one more compromise made in the name of peace.
- Rejection can later rally the desperate, but it also makes every later failure easier for the Wheel to call proof that freedom is cruelty.
...
- The future the party dismissed can reappear partly true, proving the Shard offered possibility rather than comfort.
- The interpretive lens chosen here becomes the blind spot a betrayer, propagandist, or rival uses later in the arc.
...
- Keeping or hiding the Shard supports theft attempts, courier ambushes, decoy movement, and interior security scenes where every ally is a potential leak.
- Sharing or partly destroying it supports archive defense, scramble-for-fragments scenes, or desperate efforts to preserve context before doctrine replaces evidence.

### Immediate Narrative Changes

- Keeping it centralizes strategic insight inside the party, but makes them the only obvious target worth seizing.
- Sharing or damaging it spreads burden and confusion at the same time, because more hands now hold less complete truth.

### Faction Pressure

- The Accord pushes hardest against total destruction, while the Wheel and Moebian logic both benefit if evidence becomes incomplete or selectively recoverable.
- Broad sharing alarms every faction that prefers curated prophecy and emboldens those ready to weaponize contradiction.

### Later Payoffs

- A hidden Shard becomes a later retrieval problem when someone else learns just enough to go looking.
- A partial Shard ensures later arguments are fought over missing context, not just over fact.
