# Arc III: Revelation GM Choice Prompts
...
- Run defiance, escape, or confrontation where Wheel agents openly weaponize grief, prophecy, or relief structures.
- Make the party's burdened commitment to choice visible before they have a clean answer.
- Let later failures be used by the Wheel as proof that freedom is cruelty.

### If the party accept the Wheel's logic

- Run a ritual audience, compliant passage, or soft-captivity scene where calm replaces open violence.
- Change how allies look at the party immediately: relieved, frightened, or quietly disappointed.
- Bring the acceptance back later as pressure toward one more compromise made in the name of peace.

### If the party partially bargain

- Run negotiated movement or conditional sanctuary where obedience is tested in small ways first.
- Give the party short-term coherence and long-term moral instability.
- Let rivals later ask whether the party ever really refused the Wheel at all.

## Session 3: Reading The Chronal Shard
...
### If the party keep the Shard

- Run theft attempts, courier ambushes, or interior security scenes where every ally is a possible leak.
- Centralize strategic insight inside the party and make them the obvious target.
- Turn the hidden burden into later paranoia, retrieval pressure, or doctrinal obsession.

### If the party hide the Shard

- Run decoy movement, secret handoff, or quiet exit under suspicion.
- Make the short-term gain control and the long-term gain none.
- Bring the Shard back later as a retrieval problem once someone learns just enough to start looking.

### If the party share the Shard

- Run archive defense, emergency council, or violent struggle over interpretation instead of simple custody.
- Spread burden and confusion at the same time.
- Let broader access make Arc IV more informed and more unstable.

### If the party partially destroy the Shard

- Run scramble-for-fragments, preservation of context, or a desperate effort to stop doctrine from replacing evidence.
- Make every surviving truth feel incomplete.
- Use the missing context later as the reason every faction can still argue in good faith and bad faith alike.
