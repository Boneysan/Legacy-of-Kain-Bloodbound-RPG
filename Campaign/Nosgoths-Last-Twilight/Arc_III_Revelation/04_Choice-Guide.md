# Arc III: Revelation Choice Guide
...
- Reject the Wheel's philosophy: preserves agency and resistance, but leaves the party carrying a heavier burden of uncertainty and grief.
- Accept its logic in full: gains calm, order, and short-term coherence, but effectively yields judgment to managed inevitability.
- Partially bargain: takes some practical comfort or temporary safety while resisting full submission, but invites compromise, hypocrisy, and future pressure.
- Carry forward: hardens the campaign's moral frame around freedom, burden, and whether peace without choice is still peace.
...
- Keep it: preserves direct strategic insight, but makes the party custodians of dangerous prophecy and contradiction.
- Hide it: denies rivals immediate use, but turns the Shard into a future crisis of secrecy and recovery.
- Share it: broadens understanding, but ensures factions will weaponize its truths differently.
- Partially destroy it: limits harm while preserving some knowledge, but guarantees the remaining record is incomplete and contested.
- Carry forward: decides how much of the Heart's true scale enters Arc IV and who gets to argue from evidence rather than doctrine.
