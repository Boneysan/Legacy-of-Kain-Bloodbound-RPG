...
- If someone rolls **Observation** (DR 2) during Halden's explanation: the "rider" detail is sourced too cleanly for an ad hoc cover. Someone rehearsed it. It is not a lie that emerged under pressure — it was retrieved. On a success, the player also catches that Halden's pause before answering is exactly the length of a memorized answer, not a thought.
