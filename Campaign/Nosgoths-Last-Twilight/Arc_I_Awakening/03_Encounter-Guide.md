# Arc I Encounter Guide

Use this document when you want the encounter plan for each Awakening session in one place rather than flipping between the session prep and the standalone encounter library.

## Session 1: Cathedral Road Ambush

- Primary location: Cathedral road, milestone ditch-path, and storm-broken wagon line outside Avernus.
- Primary encounter: Use Encounters/Arc_I_Awakening/01_Cathedral-Road-Ambush.md.
- Recommended lineup: 2 Acolytes of Hash'ak'gik and 1 Outcast Raider collaborator.
- Core objective: Keep the reliquary, courier, or marked witness from being dragged into the hidden access path.
- Escalation option: If the party refuses open combat, turn the same scene into a drugging, marking, or snatch attempt before steel is drawn.

## Session 2: The Healer's Smile

- Primary location: Avernus hospice chapel, side corridors, and reliquary-adjacent relief wards.
- Primary encounter: Use Encounters/Arc_I_Awakening/02_The-Healers-Smile.md.
- Recommended lineup: 1 Vessel of Hash'ak'gik and 2 Acolytes of Hash'ak'gik.
...
- Alternate package: Replace 1 Acolyte with 1 Outcast Raider or desperate hired blade if you want the lower passages to feel reused by more than one faction.
...
- Alternate package: If the party outmaneuvers the cultists, replace the fight with ritual collapse, possession cascade, and chamber instability as the main threat.
...
- Alternate package: If the party avoid a three-sided fight, use a ritual standoff with competing custody claims and one sudden betrayal instead.
...
- Core objective: Turn the end of Arc I into consequence, pursuit, and political pressure rather than one more dungeon-room battle.
- Terrain notes: Burned shrines, refugee movement, exhausted mounts, and too many witnesses for anyone to act without cost.