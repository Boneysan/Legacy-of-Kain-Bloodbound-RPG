...
- **Stealth**: +1 in darkness or moonlight.
- **Movement Effects**: While within 10 ft of a visible blood trail, fresh corpse, or Bleeding creature, you may scale vertical surfaces with a DR 1 Athletics or Evasion check.
- **Bonuses**: +1 Weapon Mastery, +1 Stealth.
- **Unique Trait**: Once per round, when a non-allied creature within 10 ft of you becomes Bloodied, drops to 0 HP, or dies, you gain 1 BP.
...
- **Feature**: *Razielim Glide* (When you fall or leap from a height, you may glide up to 60 ft horizontally, descending no more than 10 ft for every 30 ft traveled. You take no falling damage if the total fall is 60 ft or less.)
...
- **Bonus**: +1 Tactics.
- **Feature**: *Turelim Protector* (Reaction, once per scene: when an ally you can see within 30 ft is hit by an attack, reduce the damage by your Fury, to a maximum of 3.)

### 2.2.3 Dumahim
Stoic, hulking brutes, entombed for centuries.
- **Bonus**: +1 Intimidation.
- **Feature**: *Patient Earthshaker* (Action, once per scene: each enemy of your choice within 10 ft must succeed on a DR 2 Blood or Fury save or be knocked Prone or pushed 10 ft directly away from you.)
...
- **Feature**: *The Mending* (Action, once per scene: graft harvested flesh from a fresh corpse or flesh component within 5 ft onto yourself to restore 1d6 HP. If used in sight of non-Melchiahim NPCs, you suffer -1 die to Persuasion and social goodwill checks with them for the rest of the scene.)
...
- **Feature**: *Amphibious* (Passive: you can breathe both air and water. Swim speed 40 ft (8 squares). While fully submerged or in heavy rain, you gain Advantage on physical checks and attacks.)
...
- **Vulnerability**: Prolonged exposure to dry air (more than 1 hour without immersion or specialized wrappings) imposes -1 die to all physical checks and attacks. After 4 hours, take 1d4 damage per hour. Specialized alchemical moisturizers negate this for 8 hours.
...
- **Unique Trait**: *Wraith Phasing* (Bonus Action, a number of times per long rest equal to your Will: shift into a phased state until the end of your next turn. While phased, you are translucent, your Speed becomes 35 ft, you may move through terrain and barriers up to 1 ft thick, your weapon and unarmed attacks deal Spectral damage instead of their normal type, you gain Resistance to non-magical Physical damage, and you are immune to non-magical grapples and restraints. You must end your movement in an unoccupied space.)
...
- **Movement**: 30 ft (6 squares); full speed on corrupted or glyph-infused terrain.
- **Stealth**: No bonus, but Glyphcasting can alter terrain visibility.
- **Movement Effects**: Once per scene, when you move, you may add 10 ft to that movement by rolling 1 Corruption Die. On a 1, gain 1 Corruption as normal.
- **Bonuses**: +1 Glyphcasting, +1 Forbidden Knowledge.
- **Unique Trait**: Once per long rest, when you cast a spell, you may cast it without spending its BP or SE cost. After the spell resolves, gain 1 Corruption.
...
- **Stealth**: +1 in crowds or chaotic environments.
- **Movement Effects**: You may move through gaps, bars, windows, and other openings large enough for your head and one shoulder to fit. Moving through such a space costs 5 extra ft of movement.
...
- **Feature**: *Fleeting Omen* (Bonus Action, once per scene: roll 1d6 and ask the GM for a cryptic omen about one creature or situation you can perceive. The omen should grant a useful hint such as warning of harm, detecting deception, or revealing a favorable angle.)
...
- **Movement**: 25 ft (5 squares); treat graves and crypts as normal ground.
- **Stealth**: +1 in fog, smoke, or decay.
...
- **Movement Effects**: Teleport 20 ft as a Bonus Action once per session.
- **Bonuses**: +1 any skill, +1 Insight or Observation.
- **Unique Trait**: *Untethered Soul* (You automatically ignore one fate-altering magical or prophetic effect per session.); *Probability Shift* (Reaction, once per scene: after you, an ally within 30 ft, or an enemy you can see within 30 ft rolls dice, force up to 2 of those dice to be rerolled. If used on yourself or an ally, keep the higher results; if used on an enemy, use the new results.)
