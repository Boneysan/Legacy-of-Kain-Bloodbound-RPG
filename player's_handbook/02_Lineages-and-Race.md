...
- **Bonus**: +1 Tactics.
- **Feature**: *Turelim Protector* (Reaction, once per scene: when an ally you can see within 30 feet is hit by an attack, reduce the damage by your Fury, to a maximum of 3.)

### 2.2.3 Dumahim
Stoic, hulking brutes, entombed for centuries.
- **Bonus**: +1 Intimidation.
- **Feature**: *Patient Earthshaker* (Action, once per scene: each enemy of your choice within 10 feet must succeed on a DR 2 Blood or Fury save or be knocked **Prone** or pushed 10 feet directly away from you.)
...
- **Movement Effects**: Once per scene, when you move, you may add 10 feet to that movement by rolling 1 Corruption Die. On a 1, gain 1 Corruption Level as normal.
