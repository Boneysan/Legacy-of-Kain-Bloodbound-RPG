...
When a spell lists a save (e.g., *DR 2 Blood save*), the target rolls **Attribute + a relevant Skill** vs. the DR. Unless the spell specifies a skill, the player chooses a contextually appropriate one.

| Save Type | Dice Pool | Resists |
|---|---|---|
| **Blood save** | Blood + relevant skill | Physical effects: binding, poison, disease, bodily manipulation, knockback |
| **Will save** | Will + Concentration or Insight | Mental effects: fear, charm, confusion, psychic intrusion, concentration breaks |
| **Soul save** | Soul + relevant skill | Spiritual effects: soul drain, corruption, death magic, spectral possession |
| **Evasion save** | Shadow + Evasion | Dodge effects: area blasts, traps, cones, sweeping ground hazards |
| **Fury save** | Fury + relevant skill | Raw force: breaking bonds, resisting a shove or knockback by brute strength |

*When a spell names an attribute directly (e.g., "Soul attribute") roll that attribute + the most fitting skill.*
...
This compendium lists spells by tier and category. Class access by spell school is detailed in Chapter 3: Classes. Costs assume SE for Glyph/Ritual/Forbidden, BP for Blood. Casting time is 1 Action unless specified; saves use tier-appropriate DR (Initiate: 2; Adept: 2–3; Expert: 3; Master: 3–4+). Damage is static.
...
- **Glyph of Flame:** Cost: 1 SE. Touch; triggers on approach. 3 Elemental (Fire) damage in 5-ft radius (DR 2 Evasion halves).
- **Glyph of Frost:** Cost: 1 SE. Touch; triggers on approach. 1 Elemental (Cold) damage + speed -10 ft 1 round (DR 2 Fury negates speed reduction).
- **Glyph of Sparks:** Cost: 1 SE. Touch; triggers on approach. 1 Elemental (Lightning) damage + DR 2 Will save or Blinded 1 round.
- **Glyph of Thorns:** Cost: 1 SE. Touch; triggers on entry. 2 Spectral damage + DR 2 Evasion save or speed halved 1 round.
...
- **Glyph of Quicksand:** Cost: 2 SE. Touch earth; triggers on entry; DR 2 Blood or Restrained in 15x15 ft area + 1 Corruption if sunk.
- **Glyph of Severance:** Cost: 2 SE. Touch; triggers on touch; 4 Spectral damage + DR 2 Blood or sever non-magical item.
...
#### Ritual Spells
- **Ceremony of Sorrow:** Cost: 2 SE. 10 min; group mourning; remove 1 Corruption or recall memory.
...
- **Unravel Mind:** Cost: 2 SE (+1 Corruption). 30 ft; DR 3 Will or no spells/complex actions 1 min.

### 5.10.3 Expert Tier (Levels 11–15)

#### Glyph Spells
- **Glyph Lockdown:** Cost: 3 SE. Touch; triggers on entry; DR 3 Blood or Immobilized in 10-ft field 3 rounds.
- **Glyph of Collapse:** Cost: 3 SE. 1 min; touch structure; triggers collapse; DR 3 Evasion or 6 Physical (Bludgeoning) + Restrained.
...
- **Blood Cyclone:** Cost: 3 BP. Self; 20-ft radius; 5 Physical (Slashing) + DR 3 Blood or pushed/Prone.
- **Bloodlash Field:** Cost: 3 BP. 15-ft square in 60 ft; 3 Physical (Slashing) + DR 2 Evasion or pulled/Rooted for concentration 1 min.
- **Bloodrite Brand:** Cost: 3 BP. 1 min; touch; permanent brand (fealty, outcast, or suffering).
- **Bone Siphon:** Cost: 3 BP. Touch; DR 3 Blood or 5 Spectral damage + brittle bones (+2 Bludgeoning/Slashing dmg) 1 min.
- **Crimson Shackle:** Cost: 3 BP. 30 ft; spell attack + DR 3 Fury to break Restrained for concentration 1 min.
- **Crimson Surge:** Cost: 3 BP (-2 HP to self). 15-ft cone; 6 Physical (Bludgeoning) + DR 3 Blood or Prone.
- **Curse of Ash:** Cost: 2 BP. 30 ft; DR 3 Blood or no healing + 2 Spectral damage on heal attempts 3 rounds.
- **Heartburst:** Cost: 4 BP. 30 ft; DR 3 Blood or death (<20 HP) / (Level x 2) Spectral damage + Stun (once/long rest).
- **Viscera Torrent:** Cost: 3 BP (-2 HP to self). 30-ft cone; 4 Spectral damage + DR 3 Blood or Poisoned 1 min + -2 Stealth.
...
- **Soul Anchor:** Cost: 3 SE. 10 min; touch; prevent death (to 1 HP) + +2 vs. Spectral attacks until long rest.
...
- **Glyph of Judgment:** Cost: 4 SE. Touch; triggers on aggression; DR 3 Will or reflect half damage as Spectral damage 1 min.
- **Glyph of Obliteration:** Cost: 5 SE. Touch; triggers; 8 Force damage + push in 20-ft radius (DR 4 Evasion halves).
...
- **Glyph of Unraveling:** Cost: 4 SE. Touch; triggers on spell; DR 3 Will or fail + 4 Spectral damage/backlash.
- **Glyph Vortex:** Cost: 4 SE. Touch; triggers; pull + 4 Spectral damage in 15-ft area 3 rounds (DR 3 Blood).
