...
- 7.1 Weapons of Nosgoth
	- 7.1.1 Class-Specific Weapons
	- 7.1.2 Multi-Class / Universal Weapons
	- 7.1.3 Rare Weapons (GM Discretion)
	- 7.1.4 Relic Weapons (Legendary or Unique)
- 7.2 Special Damage Types
...
Note on terminology: Defense Value (DV) is the attack target in combat; Difficulty Rating (DR) is used for checks/saves; Armor is flat mitigation that reduces incoming damage before HP. Weapons and armor may reference DV (bonuses/penalties) while Armor values reduce damage directly.
...
#### 7.1.1.2 Sarafan Crusader Class
...
#### 7.1.1.3 Wraith / Spirit-Bound Class
...
#### 7.1.1.5 Forbidden Scholar / Cultist Class
...
#### 7.3.1.2 Sarafan Crusader Class
...
#### 7.3.1.3 Spirit-Bound / Wraith Class
...
#### 7.3.1.5 Forbidden Scholar / Cultist Class
...
| Feral Hide Armor      | +2 DV; +1 damage on melee critical hits                     |
