...
As you cross Corruption thresholds, you gain access to powerful but dangerous Corrupted Perks. These abilities represent the dark power you've embraced, but they come with significant drawbacks and risks.

Characters may select one Corrupted Perk each time they cross a new threshold (at Corruption Level 3, 7, and 11). These perks are in addition to your normal perk progression.
...
**Drawback:** The Spectral Realm's influence frays your connection to reality; you gain 1 Soul Drain whenever you enter or remain in the Spectral Realm for more than 1 minute per scene.
...
**Effect (Active):** Once per short rest, as a Bonus Action, you can take 1 Soul Drain to add +2 damage to your next successful weapon or spell attack this turn.
...
**Effect (Reactive):** Once per scene, when you fail a saving throw against a spell or magical effect, you can use your Reaction to reroll the save with +1 die. If you succeed, the caster takes 2 Void damage (bypassing all Armor and resistances). Costs 1 Soul Drain.
...
**Effect (Active):** As an Action, once per short rest, you emit a keening wail that affects all enemies within 30 feet (6 squares). Targets must make a DR 3 Will save. On a failure, they take 5 Soul damage (bypassing physical Armor) and cannot take Reactions until the end of their next turn. On a success, they take 2 Soul damage. Costs 2 SE and 2 Soul Drain.

**Drawback:** Your connection to the Spectral Realm deepens; you gain 1 Corruption Point, and you suffer 1 Soul Drain whenever you enter or remain in the Spectral Realm for more than 1 minute per scene until your next long rest.
